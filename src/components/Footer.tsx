...
export function Footer() {
  ...
  return (
    <footer className="my-16 max-w-7xl container-main mx-auto md:px-24">
      <div
        className="relative rounded-[2.5rem] px-8 py-12 flex flex-col md:flex-row justify-between items-center gap-6"
        style={{
